...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (loginRequestForm) {
    loginRequestForm.addEventListener('submit', (e) => {
      ...
      // Notify credentials requested
      alert('Request submitted! Our team will review your contact information. For immediate testing, please use the Demo Profiles tab and enter the correct login credentials.');
      
      // Switch back to credentials tab
      if (btnLoginTabCredentials) {
        btnLoginTabCredentials.click();
      }
    });
  }
  ...
  // ==========================================================================
  // 23. ACCESS CONTROL SUB-SECTIONS & ROSTER COMPLETION
  // ==========================================================================
  const btnAccessUserManagerTab = document.getElementById('btn-access-usermanager-tab');
  const btnAccessHierarchyTab = document.getElementById('btn-access-hierarchy-tab');
  const accessUserManagerPane = document.getElementById('access-usermanager-pane');
  const accessHierarchyPane = document.getElementById('access-hierarchy-pane');
  const btnTriggerAddUser = document.getElementById('btn-trigger-add-user');
  ...
  // Roster lists
  const accessUsers = [
    { id: 'AW', name: 'Alexander Wright', role: 'C-level / Administrator', core: true, talent: true, ops: true, finance: true },
    { id: 'CO', name: 'Clara Oswald', role: 'HR Manager', core: true, talent: true, ops: false, finance: false },
    { id: 'DV', name: 'David K. Vance', role: 'Lead Engineer', core: true, talent: false, ops: true, finance: false },
    { id: 'MB', name: 'Marcus Bennett', role: 'Operations Associate', core: true, talent: false, ops: false, finance: false },
    { id: 'JC', name: 'Jane Cooper', role: 'HR Assistant', core: true, talent: false, ops: false, finance: false },
    { id: 'ED', name: 'Emily Davis', role: 'Software Engineer', core: true, talent: false, ops: false, finance: false },
    { id: 'RF', name: 'Robert Fox', role: 'QA Engineer', core: true, talent: false, ops: false, finance: false }
  ];

  function repopulateAccessDropdown() {
